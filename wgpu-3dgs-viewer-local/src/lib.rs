...
impl<G: GaussianPod> Viewer<G> {
    ...
    /// Render the viewer.
    pub fn render(&self, encoder: &mut wgpu::CommandEncoder, texture_view: &wgpu::TextureView, viewport: Option<(f32, f32, f32, f32)>) {
        self.preprocessor
        ...
        self.renderer
            .render(encoder, texture_view, &self.indirect_args_buffer, viewport);
    }
}
